...
export default function Home() {
  ...
  //Define a function to fetch event from API
  const getEvents = () => {
    axios
  ...
  return (
    <>
      <Navbar />
      <section className="bg-[url(./assets/images/bg.png)] h-[596px] bg-cover w-[95%] mx-auto relative">
        <h1 className="text-big-heading text-white w-[30%] mx-auto text-center pt-32">
        ...
        <form className="bg-navy-blue w-[90%] mx-auto py-6 px-10 flex flex-row justify-between rounded-md absolute -bottom-12 left-[5%]">
          ...
          <div className="flex flex-col w-[30%]">
            <label className="text-white" htmlFor="when">
              When
            </label>
            <input
              type="datetime-local"
